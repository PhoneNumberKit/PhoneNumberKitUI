...
open class PhoneNumberTextField: UITextField, UITextFieldDelegate {
    ...
    let nonNumericSet: CharacterSet = {
        ...
        // Phone-input characters allowed alongside digits. Mirrors PhoneNumberKit's internal
        // normalization constants (plus / pauses-and-waits / operator), kept local so the
        // foundation package needn't expose its implementation details.
